...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  Widget _buildCircleIcon(
    ...
    return Padding(
      padding: EdgeInsets.only(right: screenWidth * 0.015), // تغيير left إلى right
    ...
    return BlocBuilder<CartCubit, CartState>(
      builder: (context, cartState) {
        ...
        return Scaffold(
          ...
          body: Directionality(
            textDirection: TextDirection.rtl, // ثابت من اليمين إلى اليسار
            child: Stack(
              children: [
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                ...
                                right: screenWidth * 0.04, // تغيير left إلى right
                                child: GestureDetector(
                                  onTap: () {
                                    Share.share(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    crossAxisAlignment:
                                    isEnglish ? CrossAxisAlignment.end : CrossAxisAlignment.start,                                      children: [
                                      Padding(
