  ...
  Future<void> _fetchProducts({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        try {
          // ✅ Fix: sometimes response.data comes as String
