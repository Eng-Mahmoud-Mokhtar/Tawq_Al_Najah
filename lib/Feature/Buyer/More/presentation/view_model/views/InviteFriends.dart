...
class InviteFriends extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int usedBy = 10; // عدد الأشخاص الذين استخدموا الكود
    final int requiredCount = 10; // عدد المستخدمين المطلوبين للحصول على المكافأة
    final bool canRequestReward = usedBy >= requiredCount;
